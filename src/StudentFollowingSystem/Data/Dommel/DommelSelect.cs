...
namespace Dommel
{
    public static class DommelSelect
    {
        ...
        public class SqlExpression<TEntity>
        {
                ...
                switch (expression.NodeType)
                {
                    case ExpressionType.Not:
                        ...
                        if (memberExpression != null &&
                            DommelMapper.Resolvers.Properties(memberExpression.Expression.Type).Any(p => p.Name == (string)o))
                        {
            ...
            {
                return DommelMapper.Resolvers.Column((PropertyInfo)expression.Member);
            }
